...
public final class FragmentHistoryBinding implements ViewBinding {
  ...
  private FragmentHistoryBinding(@NonNull LinearLayout rootView, @NonNull ProgressBar progressBar,
      @NonNull RecyclerView rvBookings, @NonNull TabLayout tabLayout, @NonNull TextView tvEmpty) {
  ...
  public static FragmentHistoryBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentHistoryBinding((LinearLayout) rootView, progressBar, rvBookings, tabLayout,
          tvEmpty);
    }
