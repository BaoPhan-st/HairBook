...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull CoordinatorLayout rootView, @NonNull AppBarLayout appBar,
      @NonNull BottomNavigationView bottomNavigation, @NonNull TextView btnProfile,
      @NonNull FrameLayout fragmentContainer, @NonNull TextView tvGreeting) {
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMainBinding((CoordinatorLayout) rootView, appBar, bottomNavigation,
          btnProfile, fragmentContainer, tvGreeting);
    }
