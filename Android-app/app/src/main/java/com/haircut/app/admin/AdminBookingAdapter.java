...
public class AdminBookingAdapter extends RecyclerView.Adapter<AdminBookingAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder h, int position) {
        ...
        if (b.customer != null) {
            String phone = (b.customer.phone != null && !b.customer.phone.isEmpty())
                    ? " · " + b.customer.phone : "";
            h.tvCustomerName.setText(b.customer.fullName + phone);
        } else {
        ...
        // Thợ
        h.tvBarberName.setText(b.barber != null ? "✂ " + b.barber.name : "—");
        ...
        if (b.service != null) {
            ...
            h.tvServiceInfo.setText(b.service.name + " — " + price + " — " + duration);
        }
        ...
        if (b.cancelReason != null && !b.cancelReason.isEmpty()
                && ("CANCELLED_BY_SALON".equals(b.status) || "CANCELLED_BY_CUSTOMER".equals(b.status))) {
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        LinearLayout layoutActions, layoutActionsConfirmed;
        Button btnConfirm, btnReject, btnComplete, btnNoShow;
